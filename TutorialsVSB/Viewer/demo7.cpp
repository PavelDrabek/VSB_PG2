...
void Demo7::initVAOs()
{
	...
	VAO* vao4 = new VAO();
	vao4->createFromModel(m_sceneData->models[1]);
...
GLuint Demo7::createTexture(const char *resourceFileName, int wrap, int filter)
{
	GLuint texID;
...
void Demo7::initSceneEntities()
{
	...
	obj = new Entity_OBJ(m_sceneData->models[0], m_sceneData->vaos[4]);
